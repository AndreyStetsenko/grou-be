...
// ------------------------------
const textFormSubmited = 'Форма отправлена';
const textFormSend = 'Отправить';
...
// add primary btn class & text
$('.actions a[role="menuitem"]').addClass("btn btn-primary");
$('.actions a[href="#previous"]').html('Назад');
$('.actions a[href="#next"]').html('Далее');

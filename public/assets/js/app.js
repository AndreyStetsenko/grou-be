(() => {
      ...
      for (let n = 1; n < e.length; n += 1) {
          ...
          if (null != r && (i = r, !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
              ...
              for (let s = 0, i = e.length; s < i; s += 1) {
                  ...
                  void 0 !== n && n.enumerable && (g(t[i]) && g(r[i]) ? r[i].__swiper__ ? t[i] = r[i] : v(t[i], r[i]) : !g(t[i]) && g(r[i]) ? (t[i] = {}, r[i].__swiper__ ? t[i] = r[i] : v(t[i], r[i])) : t[i] = r[i])
              }
          }
      }
      var i;
  ...
  const B = (e, t) => {
      ...
      D = {
          attachEvents: function() {
              ...
              e.onTouchStart = $.bind(e), e.onTouchMove = L.bind(e), e.onTouchEnd = O.bind(e), s.cssMode && (e.onScroll = I.bind(e)), e.onClick = _.bind(e), n.touch && !z && (t.addEventListener("touchstart", G), z = !0), B(e, "on")
          },
  ...
  class R {
      constructor(...e) {
          ...
          const i = this;
          i.__swiper__ = !0, i.support = y(), i.device = function(e = {}) {
              return T || (T = function({
                  userAgent: e
              } = {}) {
                  const t = y(),
          ...
          }()), S), i.eventsListeners = {}, i.eventsAnyListeners = [], i.modules = [...i.__modules__], s.modules && Array.isArray(s.modules) && i.modules.push(...s.modules);
          const n = {};
          i.modules.forEach((e => {
              e({
                  swiper: i,
          ...
          const a = v({}, j, n);
          return i.params = v({}, a, q, s), i.originalParams = v({}, i.params), i.passedParams = v({}, s), i.params && i.params.on && Object.keys(i.params.on).forEach((e => {
  ...
  K = function(e) {
  ...
  }, (J = new Image).onload = J.onerror = function() {
      K(2 == J.height)
  }, J.src = "data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA", X.use([function({
      swiper: e,
      extendParams: t,
      on: s,
      emit: i
      ...
      function d() {
          ...
          if ("fraction" === s.type && (d.find(U(s.currentClass)).text(s.formatFractionCurrent(c + 1)), d.find(U(s.totalClass)).text(s.formatFractionTotal(p))), "progressbar" === s.type) {
              ...
              let n = 1,
                  r = 1;
              "horizontal" === t ? n = i : r = i, d.find(U(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${r})`).transition(e.params.speed)
          }
      ...
      ! function() {
          ...
          let e = document.querySelectorAll(".reviews__slide");
          window.innerWidth < 767 && (e.forEach((e => {
              e.insertAdjacentHTML("beforebegin", e.innerHTML), e.remove()
          })), e = document.querySelectorAll(".reviews__item"), e.forEach((e => {
              e.classList.add("reviews__slide")
          }))), new X(".reviews__slider", {
              slidesPerView: 3,
              spaceBetween: 30,
          ...
          const t = document.querySelectorAll(".media__slide");
      ...
      function() {
          const e = document.querySelector(".header"),
              ...
              s = document.querySelector(".header__burger"),
              i = document.querySelector(".layer"),
              n = document.querySelector("html");
          e.addEventListener("click", (function(e) {
              (e.target.classList.contains("header__burger") || e.target.classList.contains("layer")) && (s.classList.toggle("active"), t.classList.toggle("active"), i.classList.toggle("active"), n.classList.toggle("active"))
          }))
      }()
  }))
})();
          ...
          <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
            <div class="card-header pb-1">
              <div class="card-title">
                <h4 class="text-center mb-2">Добро пожаловать в <b>Grou</b></h4>
              </div>
            </div>
            <div class="card-body">
              {{-- form  --}}
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group d-flex flex-md-row flex-column justify-content-between align-items-center">
                  ...
                  <div class="text-right">
                    <a href="{{ route('password.request') }}" class="card-link"><small>Забыли пароль?</small></a>
                  </div>
                </div>
                <button type="submit" class="btn btn-primary glow w-100 position-relative">Вход
                  <i id="icon-arrow" class="bx bx-right-arrow-alt"></i>
                </button>
              </form>
              <hr>
              <div class="text-center">
                <small class="mr-25">Нет аккаунта?</small>
                <a href="{{route('register')}}"><small>Регистрация</small></a>
              </div>
            </div>
          </div>
        </div>

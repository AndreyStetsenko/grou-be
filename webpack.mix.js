...
// main site styles
mixAssetsDir('mainSite/scss/**/!(_)*.scss', (src, dest) => mix.sass(src, dest.replace(/(\\|\/)sass(\\|\/)/, '$1css$2').replace(/(\\|\/)scss(\\|\/)/, '$1css$2').replace(/\.scss$/, '.css')));
...
// main site scripts
mixAssetsDir('mainSite/js/**/*.js', (src, dest) => mix.scripts(src, dest));
